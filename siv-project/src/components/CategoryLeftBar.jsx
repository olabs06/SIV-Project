        ...
        <div className="px-4 text-black-light">
            ...
            <div className="pt-8">
                ...
                <div className="form-check">
                    ...
                    <label className="form-check-label inline-block text-black-500" for="flexCheckChecked">
                        Full time
                    </label>
                </div>
                <div className="form-check">
                    <input className="form-check-input appearance-none h-4 w-4 border border-gray-300 bg-white checked:bg-blue-light checked:border-2 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-center float-left mr-2 cursor-pointer rounded-full" type="checkbox" value="fullTime" id="fullTime" />
                    <label class="form-check-label inline-block text-black-500" for="flexCheckChecked">
                        Holiday Placement
                    </label>
                </div>
                <div className="form-check">
            ...
            <div className="mt-4 relative">
                ...
                <input type="text" className="w-full bg-black-5 border-black-250 relative p-4 rounded-full h-[28px] shadow-shadow-113 placeholder:text-sm" placeholder="Select Work Type" />
            ...
            <div className="mt-4 relative">
                ...
                <input type="text" className="w-full bg-black-5 border-black-250 relative p-4 rounded-full h-[28px] shadow-shadow-113 placeholder:text-sm" placeholder="Select Tip Culture" />
                <button className="material-icons absolute right-1 top-[32px] text-black-light opacity-50">arrow_drop_down</button>
            </div>
            ...
            <div className="mt-4 relative">
                ...
                <input type="text" className="w-full bg-black-5 border-black-250 relative p-4 rounded-full h-[28px] shadow-shadow-113 placeholder:text-sm" placeholder="Select Tip Frequency" />
                <button className="material-icons absolute right-1 top-[32px] text-black-light opacity-50">arrow_drop_down</button>
            </div>
