      ...
      <div class="w-82">
        <form className="bg-white py-4 w-full">
          ...
          <div className="mb-3 px-2">
            ...
            <input className="shadow-input-shadow appearance-none border h-10 w-full py-2 px-8 text-black-white opacity-50 leading-tight focus:outline-none rounded-full bg-blue-background placeholder-black-light" id="email" name="email" type="email" placeholder="Enter your email" />
          </div>
          ...
          <div className="mb-3 px-2">
            ...
            <input className="shadow-input-shadow appearance-none border h-10 w-full py-2 px-8 text-black-white opacity-50 leading-tight focus:outline-none rounded-full bg-blue-background placeholder-black-light" id="email" name="email" type="email" placeholder="Enter your password" />
          </div>
          ...
          <div className="h-12 flex flex-col justify-center items-center">
            ...
            <button className="w-full capitalize px-4 rounded-full h-10 bg-ash-light text-blue-dark leading-10 self-center shadow-input-shadow">signin</button>
